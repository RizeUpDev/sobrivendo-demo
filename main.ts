function gameStartingMenu () {
    ...
    scene.setBackgroundImage(img`
        ...
        `)
    myTextSprite = fancyText.create("Sobrivendo", 0, 4, fancyText.rounded_large)
    myTextSprite.setPosition(70, 56)
    myTextSprite2 = fancyText.create("Press 'A' to start", 0, 4, fancyText.italic_small)
    myTextSprite2.setPosition(95, 75)
    ...
    miniMenu.onButtonPressed(myMenu, miniMenu.Button.A, function (selection, selectedIndex) {
        if (selectedIndex == 0) {
            ...
            mySprite2 = shader.createImageShaderSprite(img`
                . . . f f f f f f f f . . . 
